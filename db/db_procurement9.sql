...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2019 at 05:38 AM
...
(3, 40, 335, 1, 'brand/offer4', '140.00', 60, 60, 2);
...
(1, 1000, 1, 1, 0, 0, '2019-05-15 16:05:24');
...
(1, '2019-05-15', '1111', 40, '', 1, 20, 1, 0, NULL, NULL);
...
(1, 1, 1, 1, 334, 'brand.offer1', 100, '80.00'),
(2, 1, 1, 2, 337, 'brand.offer2', 50, '150.00');
...
--
ALTER TABLE `dr_details`
MODIFY `dr_details_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
