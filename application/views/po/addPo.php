                                ...
                                <table class="table-bordered" width="100%" style="margin-top: 20px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 0px!important"><input type="text" name="price<?php echo $x; ?>" id="price<?php echo $x; ?>" value="<?php echo $it['price']; ?>"  onkeypress="return isNumberKey(this, event)" class="form-control emphasis" onblur='changePrice(<?php echo $x; ?>,0)' style='border:0px'></td>
