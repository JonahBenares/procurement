function itemDetails(baseurl) {
    window.open(baseurl+"index.php/items/item_details", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=45,left=25,width=1300,height=600");
}
function vendorDetails(baseurl) {
    window.open(baseurl+"index.php/vendors/vendor_details", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=45,left=25,width=1300,height=600");
}
function updateItem(baseurl) {
    window.open(baseurl+"index.php/items/update_item", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=50,left=450,width=500,height=500");
}
function viewVendor(baseurl) {
    window.open(baseurl+"index.php/vendors/view_vendors_per_item", "_blank","toolbar=yes,scrollbars=yes,resizable=yes, top=100,left=80,width=1200,height=400");
}
function updateVendor(baseurl) {
    window.open(baseurl+"index.php/vendors/update_vendor", "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=50,left=450,width=500,height=500");
}
